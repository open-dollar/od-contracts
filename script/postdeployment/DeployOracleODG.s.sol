...
// BROADCAST
// source .env && forge script DeployOracleODG --with-gas-price 2000000000 -vvvvv --rpc-url $GOERLI_RPC --broadcast --verify --etherscan-api-key $ETHERSCAN_API_KEY

// SIMULATE
// source .env && forge script DeployOracleODG --with-gas-price 2000000000 -vvvvv --rpc-url $GOERLI_RPC

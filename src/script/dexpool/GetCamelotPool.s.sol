...
// BROADCAST
// source .env && forge script GetCamelotPool --with-gas-price 2000000000 -vvvvv --rpc-url $ARB_GOERLI_RPC --broadcast --verify --etherscan-api-key $ARB_ETHERSCAN_API_KEY

// SIMULATE
// source .env && forge script GetCamelotPool --with-gas-price 2000000000 -vvvvv --rpc-url $ARB_GOERLI_RPC

contract GetCamelotPool is GoerliContracts, Script {

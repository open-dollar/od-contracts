...
switch (proposalType) {
    case 'addcollateral':
        const outputPath = path.join(__dirname, `../gov-input/${targetEnv}/new-addCollateral-prop.json`);
        ...
        if (inputs.length == 6) {
            ...
            console.error("Unrecognized number of params.  This function requires 6 inputs.");
            process.exit(1);
        }

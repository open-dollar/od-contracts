...
abstract contract E2EStabilityFeeTreasuryTest is BaseUser, Common {
  ...
  function test_give_funds() public restoreOriginalCaller {
    // Collecting fees for stabilityFeeTreasury
    _gatherFees();
  ...
  function test_take_funds() public restoreOriginalCaller {
  ...
  function test_pull_funds() public restoreOriginalCaller {
    // Collecting fees for stabilityFeeTreasury
    _gatherFees();
  ...
  function test_transfer_surplus_funds() public restoreOriginalCaller {
    // Collecting fees for stabilityFeeTreasury
    _gatherFees();
  ...
  function test_repay_debt_before_pull() public restoreOriginalCaller {
    // Collecting fees for stabilityFeeTreasury
    _gatherFees();
    uint256 _coinBalance = safeEngine.coinBalance(address(stabilityFeeTreasury));
    uint256 _previousAliceBalance = safeEngine.coinBalance(alice);
  ...
  function test_join_coins_before_pull() public restoreOriginalCaller {
    uint256 _wad = INITIAL_DEBT;

...
contract E2EOracleSetup is HaiTest {
  ...
  function setUp() public {
    ...
    address _uptimeFeed = CHAINLINK_UPTIME_FEED;

    // --- Chainlink ---
    wethUsdPriceSource = new ChainlinkRelayer(CHAINLINK_ETH_USD_FEED, _uptimeFeed, 1 days);
    wstethEthPriceSource = new ChainlinkRelayer(CHAINLINK_WSTETH_ETH_FEED, _uptimeFeed, 1 days);
    cbethEthPriceSource = new ChainlinkRelayer(CHAINLINK_CBETH_ETH_FEED, _uptimeFeed, 1 days);
